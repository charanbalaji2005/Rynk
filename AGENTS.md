# AGENTS.md — Agent & Assistant Guidelines for Rynk
...
4. **Actual Windows and macOS Validation**
   ...
   - Fix platform path normalization (Windows backslashes, drive letters, case-insensitivity, and symlink permissions).
